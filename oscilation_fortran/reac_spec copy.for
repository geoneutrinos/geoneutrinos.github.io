...
c power (GW) of reactor
      rpwr=3.2
      call nuosc13(rdist,rpwr,wiggles)
      open(34,file='barna_spec_wigs13.dat')
      do j=1,1000
      ...
      subroutine nuosc12(dist,pwr,oscspec)
...
c Gonzalez-Garcia et al. JHEP 11(2014)52
      ...
      subroutine nuosc13(dist,pwr,oscspec)
      dimension oscspec(1000)
      parameter(pi=3.14159,earth_rad_sq=4.059e7)
c parameters from arXiv:1409.5439
c Gonzalez-Garcia et al. JHEP 11(2014)52
      parameter (dmsq=2.457e-3,ddmsq=0.047e-3)
      parameter (dmsq21=7.50e-5,ddmsq21=0.19e-5)
      parameter (s2t13=0.0218,ds2t13=0.0010)
      parameter (s2t12=0.304,ds2t12=0.013)
      c4t13=(1.-s2t13)*(1.-s2t13)
      s22t12=4.*s2t12*(1.-s2t12)
      s22t13=4.*s2t13*(1.-s2t13)
      c2t12=(1.-s2t12)
c normal neutrino mass ordering
      dmsq31=dmsq
      dmsq32=dmsq31-dmsq21
c inverted neutrino mass ordering should be an option
      osarg21=1.27*dmsq21*dist*1000.
      osarg31=1.27*dmsq31*dist*1000.
      osarg32=1.27*dmsq32*dist*1000.
      flux=pwr*earth_rad_sq/(dist*dist)
      do jj=1,1000
         oscspec(jj)=0.0
      end do
      do k=1,1000
         enu=float(k)*.01
         supr21=c4t13*s22t12*sin(osarg21/enu)**2
         supr31=s22t13*c2t12*sin(osarg31/enu)**2
         supr32=s22t13*s2t12*sin(osarg32/enu)**2

c         print *, '', spur21, spur31, spur32
         pee=1.-supr21-supr31-supr32
         print *, '', pee
c         pee=c4t13*(1.-s22t12*sin(oscarg/enu)**2)+s2t13*s2t13
         oscspec(k)=pee*flux
      end do
      return
      end
